...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_getFromURL_failsOnRequestError() {
        ...
        URLPrtocolStub.stub(url: url, data: nil, response: nil, error: error)
    ...
    private class URLPrtocolStub: URLProtocol {
        ...
        override class func canInit(with request: URLRequest) -> Bool {
            ...
            return URLPrtocolStub.stubs[url] != nil
        }
        ...
        override func startLoading() {
            guard let url = request.url, let stub = URLPrtocolStub.stubs[url] else { return }
